...
class InternalQAScraper(Scraper):
    ...
    def scrape(self):
        ...
        df = pd.read_csv(open("COVID19infosheet - Info.tsv", 'r'), sep="\t") #, encoding='utf-8', engine='c')
        ...
        turked_df = pd.read_csv(open("COVID19infosheet - Questions from Turkle .tsv", 'r'), sep="\t")
